        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6 lg:gap-12">
          ...
          <div className="flex flex-col items-center lg:items-end gap-4">
            <div className="flex items-center gap-4 sm:gap-6 md:gap-8">
              <LinkedInButton>
                <a href="https://www.linkedin.com/company/ai-evoke/?viewAsMember=true" className="LinkedinBtn">
              ...
              <InstagramButton>
                <a href="www.instagram.com/ai_evoke?igsh=N2o4NXlvY2Q4emc1" className="Btn">
                  <span className="svgContainer">
